...
- [ ] 3. Add durable start model fields
  ...
  - [ ] 3.7 Render registered callbacks in DescribeWorkflowExecution
  ...
  - [ ] 3.8 Apply `on_conflict_options` under USE_EXISTING
...
- [ ] 4. Add required tests
  ...
  - [ ] 4.4 Property test: Callback Describe Fidelity
  ...
  - [ ] 4.5 Property test: Conflict-Policy Defaulting
...
- Field accounting is anchored to the v1.62.11 proto (29 Start fields, 27 SignalWithStart fields), not to `UNSUPPORTED_FIELDS.md`, which is refreshed by task 1.3.
