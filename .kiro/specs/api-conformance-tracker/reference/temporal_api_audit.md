...
| `WorkflowService.DeleteWorkflowExecution` | Stable/normal | **Partial** | Handler present | `crates/tokeira-edge/src/grpc/workflow_service.rs:574` | Delete handler exists; asynchronous deletion semantics and retention interactions are not proven. |
