...
- [x] 1. Define domain types and BatchOperationStore in tokeira-runtime
  - [x] 1.1 Create `crates/tokeira-runtime/src/batch.rs` with domain types
  ...
  - [x] 1.2 Implement `BatchOperationStore` with DashMap backing
  ...
  - [x] 1.3 Add `pub mod batch;` to `crates/tokeira-runtime/src/lib.rs`
    - Add module declaration and re-export public types
    - _Requirements: 1.1_

  - [x]* 1.4 Write property test: batch store CRUD correctness (Property 1)
  ...
  - [x]* 1.5 Write property test: pagination completeness (Property 5)
  ...
  - [x]* 1.6 Write property test: idempotent stop on terminal state (Property 6)
...
- [x] 2. Implement proto translation for batch operations
  - [x] 2.1 Create `crates/tokeira-edge/src/translate/batch.rs` with translation functions
  ...
  - [x] 2.2 Add `pub mod batch;` to `crates/tokeira-edge/src/translate/mod.rs`
    - _Requirements: 3.1_

  - [x] 2.3 Update `crates/tokeira-edge/UNSUPPORTED_FIELDS.md` for batch types
  ...
  - [x]* 2.4 Write property test: proto translation round-trip (Property 3)
  ...
  - [x]* 2.5 Write property test: proto validation rejects invalid inputs (Property 4)
...
- [x] 3. Implement start_batch_operation handler
  - [x] 3.1 Add `batch_store: Arc<BatchOperationStore>` to `WorkflowService` struct
  ...
  - [x] 3.2 Implement `start_batch_operation` method on `WorkflowService`
  ...
  - [x] 3.3 Wire `start_batch_operation` in gRPC handler
  ...
  - [x]* 3.4 Write unit tests for start handler validation
...
- [x] 5. Implement BatchExecutionEngine
  - [x] 5.1 Implement `run_batch_operation` async function in `crates/tokeira-edge/src/batch_engine.rs`
  ...
  - [x] 5.2 Implement `apply_operation` dispatch function
  ...
  - [x] 5.3 Implement rate limiting with `compute_sleep_duration`
  ...
  - [x]* 5.4 Write property test: progress counter accuracy (Property 2)
  ...
  - [x]* 5.5 Write unit tests for execution engine
  ...
  - [x]* 5.6 Write integration tests for engine operation dispatch
...
- [x] 7. Implement lifecycle handlers (stop, describe, list)
  - [x] 7.1 Implement `stop_batch_operation` method on `WorkflowService`
  ...
  - [x] 7.2 Implement `describe_batch_operation` method on `WorkflowService`
  ...
  - [x] 7.3 Implement `list_batch_operations` method on `WorkflowService`
  ...
  - [x] 7.4 Wire lifecycle handlers in gRPC layer
  ...
  - [x]* 7.5 Write unit tests for lifecycle handlers
