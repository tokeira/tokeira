...
- [x] 1. Broker atomic claim methods and worker registry check
  ...
  - [x] 1.3 Add `has_active_poller` to `PollerRegistry`
  ...
  - [x]* 1.8 Write property test for `has_active_poller` lookup correctness
...
- [x] 3. Phase 1 — Eager WFT on StartWorkflowExecution
  ...
  - [x] 3.2 Implement eager WFT dispatch in `start_workflow_execution`
