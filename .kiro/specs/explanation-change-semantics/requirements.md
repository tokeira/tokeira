...
| Tier | Kinds | Policy |
|---|---|---|
| **Tier 1 — operating set** | `ComposeService`, `ObservabilityConfigFilesResource` (compose-syn), `LocalStateDirResource` | SHALL declare every field with a citation or an explicit engine-fact justification. These run on the platform operators use today. |
