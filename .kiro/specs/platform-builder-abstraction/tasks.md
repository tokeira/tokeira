...
- [ ] 8. Implement trusted platform/frontend discovery and static provisioner assembly
  - [x] 8.1 Implement source and published platform catalogs in `tkr`
  ...
  - [x] 8.2 Implement source and published Definition Frontend catalogs
...
- [x] 9. Add required configuration-identity and discovery/assembly property tests
  - [x] 9.1 Property test: Property 7 — configuration identity follows admitted semantics
  ...
  - [x] 9.2 Property test: Property 22 — catalog resolution and assembly select one platform and frontend
