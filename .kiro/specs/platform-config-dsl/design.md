...
[`platforms/compose-syn/definition.tkd`](../../../platforms/compose/deployment.tkd) *(dir renamed `platforms/compose`, 2026-07-30; document split, root now `deployment.tkd`)*: `config()` plus a
