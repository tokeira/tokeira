    ...
    fn build_deployment_record(
        ...
        StoredWorkerDeployment {
            ...
            routing_config: StoredRoutingConfig {
                ...
                current_version_revision_number: i64::from(case.version_count) + case_index as i64,
                ramping_version_revision_number: i64::from(case.version_count) + case_index as i64,
            },
