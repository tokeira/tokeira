//! Workflow and activity definitions for the hello-world
//! example.
//!
//! Adapted from the sdk-core hello_world example:
//! https://github.com/temporalio/sdk-core/tree/master/crates/sdk/examples/hello_world

#![allow(unreachable_pub)]
use std::time::Duration;
use temporalio_macros::{
    activities, workflow, workflow_methods,
};
use temporalio_sdk::{
