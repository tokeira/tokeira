...
//!     .instrument(tracing::info_span!("dagger.operation"))
//!     .await?;
//! println!("{version}");
//! # Ok(())
//! # }
...
#[doc(hidden)]
pub mod __private {
    pub use crate::{id_input::GeneratedIdInputShape, module::__private::*};
    pub use serde;
}
...
mod loadable {
    ...
    pub(crate) mod private {
        use crate::{lifecycle::SessionHandle, query::Selection};
