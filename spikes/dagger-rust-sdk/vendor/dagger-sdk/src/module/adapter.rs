...
use super::{
    context::{CurrentCall, ModuleCancellation, ModuleContextBase},
    dispatch::{
        CallOutcome, DispatchError, DispatchRegistry, RegistrationSink, ResultPublishError,
        ResultSink, handle_call,
    },
    wire::{
...
mod tests {
    ...
    use crate::{
        ...
        module::{
            codec::__private::ModuleBoxFuture,
            dispatch::{InvocationError, PreparedCall, RegistrationError},
            view::{ArgumentView, FunctionView, ModuleDescriptorView, RegistrationView},
        },
        test_support::io_proptest_config,
    };
