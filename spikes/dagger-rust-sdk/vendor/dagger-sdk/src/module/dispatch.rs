...
use super::{
    ...
    error::ModuleError,
    view::{ModuleDescriptorView, RegistrationView},
    wire::{CallEnvelope, CallIdentity, CallSelector, ModuleJson},
};
...
mod tests {
    ...
    use crate::{
        ...
        lifecycle::SessionHandle,
        module::{
            context::{CurrentCall, ModuleCancellation},
            view::{ArgumentView, FunctionView},
            wire::{ModuleFunctionName, ModuleWireName, NamedModuleArgument},
        },
        query::QueryBuilder,
        test_support::{io_proptest_config, proptest_config},
    };
